    ...
    <div class="chodal-footer"> 
	  <form action="../redirect.php" method="post" id="logout">
	   <div id="chodal_logout">
	    <input type="hidden" name="redirect_link" id="redirect_link" value="./courses/neuralnet.php">
...
<div class="container">
 ...
 <div class="description">
	<p>A neural network is a network or circuit of neurons, or in a modern sense, an artificial neural network, composed of artificial neurons or nodes. </p>
	<p>Thus a neural network is either a biological neural network, made up of real biological neurons, or an artificial neural network, for solving artificial intelligence (AI) problems. The connections of the biological neuron are modeled as weights. A positive weight reflects an excitatory connection, while negative values mean inhibitory connections. All inputs are modified by a weight and summed. This activity is referred as a linear combination. Finally, an activation function controls the amplitude of the output. For example, an acceptable range of output is usually between 0 and 1, or it could be −1 and 1.</p>
	<p>Unlike von Neumann model computations, artificial neural networks do not separate memory and processing and operate via the flow of signals through the net connections, somewhat akin to biological networks.

These artificial networks may be used for predictive modeling, adaptive control and applications where they can be trained via a dataset. Self-learning resulting from experience can occur within networks, which can derive conclusions from a complex and seemingly unrelated set of information.</p>
...
<?php
	...
	$uploaded_files = "";
	Settings::$uploadFolder .= "/neuralnet";
	$message="";
...
while (($file = readdir($dh)) !== false) 
{
 if($file != '.' && $file != '..')
 {
	...
	$filename = "./uploads/neuralnet/".$file;
	$parts = explode("♀", $file);
...
<!-- FILE UPLOADING MODULE FRONT END DESIGN HERE -->
	<div id="fileuploadmodule">
		...
		<input type="hidden" name="subject" value="neuralnet" readonly/>
