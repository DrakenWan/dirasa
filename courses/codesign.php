    ...
    <div class="chodal-footer"> 
	  <form action="../redirect.php" method="post" id="logout">
	   <div id="chodal_logout">
	    <input type="hidden" name="redirect_link" id="redirect_link" value="./courses/codesign.php">
...
<h1> Software Hardware Co-Design </h1>
<div class="container">
 
 <div class="description">
	<p>Hardware/software codesign investigates the concurrent design of hardware and software components of complex electronic systems. It tries to exploit the synergy of hardware and software with the goal to optimize and/or satisfy design constraints such as cost, performance, and power of the final product. At the same time, it targets to reduce the time-to-market frame considerably.</p>
...
<?php
	...
	$uploaded_files = "";
	Settings::$uploadFolder .= "/codesign";
	$message="";
...
while (($file = readdir($dh)) !== false) 
{
 if($file != '.' && $file != '..')
 {
	...
	$filename = "./uploads/codesign/".$file;
	$parts = explode("♀", $file);
...
<!-- FILE UPLOADING MODULE FRONT END DESIGN HERE -->
	<div id="fileuploadmodule">
		...
		<input type="hidden" name="subject" value="codesign" readonly/>
